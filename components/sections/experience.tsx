...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="py-24 md:py-32 px-4 sm:px-8 lg:px-16 bg-black">
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-40 z-10 self-start">
            ...
            >
              <h2 className="text-7xl md:text-8xl lg:text-9xl font-black text-white leading-[0.8] tracking-tighter uppercase break-all sm:break-normal lg:whitespace-pre-line">
                EXP<br />ERI<br />ENCE<span className="text-blue-500">.</span>
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="w-16 h-1 bg-blue-600 hidden lg:block" />
              </div>
          ...
          <div className="lg:w-2/3 space-y-40">
            {experience.map((exp: any, idx: number) => (
              <motion.div
                ...
                className="group relative pb-20 border-b border-white/5 last:border-0"
              >
                <div className="space-y-12">
                  {/* Period & Role */}
                  <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-8">
                    <div className="space-y-4">
                      <h3 className="text-4xl md:text-6xl font-black text-white tracking-tight group-hover:text-blue-500 transition-colors duration-500 leading-[1.1]">
                        {exp.role}
                      </h3>
                    ...
                    <div className="shrink-0 text-xs font-mono tracking-[0.5em] text-blue-500/50 uppercase bg-blue-500/5 px-4 py-2 rounded-full border border-blue-500/10">
                      {exp.period}
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 pt-16 border-t border-white/5">
                    {exp.highlights.map((highlight: string, i: number) => (
                      <motion.div
                        ...
                        whileHover={{ x: 10 }}
                      >
                        <span className="text-xs font-mono text-zinc-900 group-hover/item:text-blue-500 transition-colors mt-2">
                          {i < 9 ? `0${i + 1}` : i + 1}
                        </span>
            ...
            {/* Final space at the bottom to ensure the last item is readable while the title is sticky */}
